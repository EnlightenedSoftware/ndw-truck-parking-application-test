...
import org.ndw.myapp.domain.Address;
import org.ndw.myapp.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.street(UPDATED_STREET).houseNumber(UPDATED_HOUSE_NUMBER).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.houseNumber(UPDATED_HOUSE_NUMBER).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.street(UPDATED_STREET).houseNumber(UPDATED_HOUSE_NUMBER).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);
