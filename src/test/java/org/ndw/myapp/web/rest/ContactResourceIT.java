...
import org.ndw.myapp.domain.Contact;
import org.ndw.myapp.repository.ContactRepository;
...
class ContactResourceIT {
    ...
    void putNewContact() throws Exception {
        ...
        updatedContact.department(UPDATED_DEPARTMENT).emailAddress(UPDATED_EMAIL_ADDRESS).phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void partialUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.department(UPDATED_DEPARTMENT).phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.department(UPDATED_DEPARTMENT).emailAddress(UPDATED_EMAIL_ADDRESS).phoneNumber(UPDATED_PHONE_NUMBER);
