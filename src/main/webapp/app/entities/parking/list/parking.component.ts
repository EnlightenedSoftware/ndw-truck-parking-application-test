...
export class ParkingComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.parkingService
      ...
      .subscribe({
        next: (res: HttpResponse<IParking[]>) => {
  ...
  trackId(_index: number, item: IParking): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IParking[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
