...
import org.ndw.myapp.repository.OrganizationRepository;
...
/**
 * REST controller for managing {@link org.ndw.myapp.domain.Organization}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Organization> result = organizationRepository
            ...
            .map(existingOrganization -> {
                ...
                if (organization.getEmailAddress() != null) {
                    existingOrganization.setEmailAddress(organization.getEmailAddress());
                }
